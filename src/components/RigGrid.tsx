    ...
    return (
        <div>
            ...
            <div className="mb-5 flex flex-wrap items-center gap-4 font-outfit text-xs text-on-surface-variant/50">
                ...
                <div className="flex items-center gap-1.5">
                    <div className="h-2.5 w-2.5 rounded-full bg-btn-red" />
                    Selected
                </div>
                <div className="flex items-center gap-1.5">
                    <div className="h-2.5 w-2.5 rounded-full bg-on-surface-variant/20" />
                    Booked
                </div>
            </div>
                ...
                {rigs.map((rig) => {
                    ...
                    return (
                        <button
                            ...
                            aria-label={`${rig.name} — ${rig.specs}${isBooked ? " (booked)" : isInUse ? " (in use)" : ""}`}
                        ...
                        >
                            ...
                            {/* Status label for unavailable rigs */}
                            {isInUse && (
                                <span className="mt-1.5 rounded-full bg-sky-500/10 px-2 py-0.5 text-[9px] font-semibold text-sky-400">
                                    In Use
                                </span>
                            )}
                            {isBooked && !isInUse && (
